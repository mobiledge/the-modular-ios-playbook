...
*Illustrative figures; measure your own in [`code/ch02-design-system`](https://github.com/mobiledge/the-modular-ios-playbook/tree/main/code/ch02-design-system). The headline win is the shared, authoritative reference — the ~40s → ~5s loop is what keeps it honest.*
