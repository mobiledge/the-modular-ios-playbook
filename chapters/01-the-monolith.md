...
*These are illustrative figures for a mid-size app; measure your own in `code/ch01-the-monolith`. What matters is the order of magnitude — and how far each number falls as the chapters go.*
