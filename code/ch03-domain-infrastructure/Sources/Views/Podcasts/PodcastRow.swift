...
/// including the save-to-Library affordance added in this chapter: the whole
/// row is one `DSMediaRow`, and the row talks to the domain's
/// `LibraryUseCase` rather than Core Data directly.
